   ...
   return (
    ...
    <nav className="bg-white dark:bg-gray-900  w-full fixed z-50 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      ...
      <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
          <Image src="https://t3.ftcdn.net/jpg/04/34/37/76/360_F_434377688_1RQdwGB8IjGPyuNsQgEcp0yGVYDR8yPz.jpg" className="h-8 w-8" alt="Flowbite Logo" width="32" height="32"/>
